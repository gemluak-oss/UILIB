...
local Themes = {
	...
	Dark = {
        ...
        InputIndicator = Color3.fromRGB(180, 180, 180), -- border slider/input
        InputIndicatorFocus = Color3.fromRGB(200, 200, 200),
        Dialog = Color3.fromRGB(40, 40, 40),
        DialogHolder = Color3.fromRGB(30, 30, 30),
        DialogHolderLine = Color3.fromRGB(150, 150, 150),
        DialogButton = Color3.fromRGB(50, 50, 50),
        DialogButtonBorder = Color3.fromRGB(150, 150, 150),
        DialogBorder = Color3.fromRGB(150, 150, 150), -- border dialog utama
