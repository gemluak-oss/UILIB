...
local Themes = {
	...
	Dark = {
        ...
        AcrylicBorder = Color3.fromRGB(255, 255, 255),  -- border window utama
        ...
        InputIndicator = Color3.fromRGB(255, 255, 255), -- border slider/input
        ...
        DialogBorder = Color3.fromRGB(255, 255, 255), -- border dialog utama
