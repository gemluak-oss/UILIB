...
local Themes = {
	...
	Dark = {
		Name = "Dark",
		Accent = Color3.fromRGB(255, 165, 100), -- oranye lembut
        AcrylicMain = Color3.fromRGB(35, 35, 35), -- gelap tapi tidak hitam pekat
        AcrylicBorder = Color3.fromRGB(100, 70, 50),  -- border window, hangat
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(35, 35, 35), Color3.fromRGB(45, 40, 35)),
        AcrylicNoise = 0.2,
        TitleBarLine = Color3.fromRGB(120, 80, 50),
        Tab = Color3.fromRGB(60, 45, 35),
        Element = Color3.fromRGB(55, 45, 35),
        ElementBorder = Color3.fromRGB(180, 120, 80), -- border element hangat
        InElementBorder = Color3.fromRGB(200, 140, 90),
        ElementTransparency = 0,
        ToggleSlider = Color3.fromRGB(140, 90, 60),
        ToggleToggled = Color3.fromRGB(255, 165, 100), -- aksen oranye
        SliderRail = Color3.fromRGB(80, 60, 50),
        DropdownFrame = Color3.fromRGB(50, 40, 35),
        DropdownHolder = Color3.fromRGB(45, 35, 30),
        DropdownBorder = Color3.fromRGB(180, 120, 80),
        DropdownOption = Color3.fromRGB(60, 50, 45),
        Keybind = Color3.fromRGB(50, 40, 35),
        Input = Color3.fromRGB(55, 45, 35),
        InputFocused = Color3.fromRGB(75, 60, 50),
        InputIndicator = Color3.fromRGB(200, 140, 90),
        InputIndicatorFocus = Color3.fromRGB(255, 165, 100),
        Dialog = Color3.fromRGB(45, 35, 30),
        DialogHolder = Color3.fromRGB(40, 30, 25),
        DialogHolderLine = Color3.fromRGB(180, 120, 80),
        DialogButton = Color3.fromRGB(55, 45, 35),
        DialogButtonBorder = Color3.fromRGB(200, 140, 90),
        DialogBorder = Color3.fromRGB(180, 120, 80),
        DialogInput = Color3.fromRGB(55, 45, 35),
        DialogInputLine = Color3.fromRGB(180, 120, 80),
        Text = Color3.fromRGB(220, 200, 180), -- lembut, tidak silau
        SubText = Color3.fromRGB(180, 160, 140),
        Hover = Color3.fromRGB(80, 60, 50),
        HoverChange = 0.04
	},
}
