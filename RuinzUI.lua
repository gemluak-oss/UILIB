...
local Themes = {
	...
	AMOLED = {
        ...
        AcrylicBorder = Color3.fromRGB(255, 255, 255),  -- window border
        ...
        ElementBorder = Color3.fromRGB(255, 255, 255), -- border element
        ...
        InputIndicator = Color3.fromRGB(255, 255, 255), -- border input
        ...
        DialogButtonBorder = Color3.fromRGB(255, 255, 255), -- border button
        DialogBorder = Color3.fromRGB(255, 255, 255), -- border dialog
        DialogInput = Color3.fromRGB(0, 0, 0),
        DialogInputLine = Color3.fromRGB(255, 255, 255), -- input line
